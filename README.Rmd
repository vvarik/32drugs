...
8. Now we fit a curve to this data. We use some equation that describes the
   ...
   four parameter logistic regression [4PL](doc/4pl.md). We have to make one
   more brief detour into [formula interface](doc/formulaR.md), very powerful
   and indispensable tool for modelling in R.

...
11. Estimating growth rate from log phase slope makes fewer assumptions and
    generally works well. The major requirement is to have at least 3-4
    datapoints from the exponential part of the growth curve.
